...
- Codex and [codex-acp](https://github.com/zed-industries/codex-acp) for AI code completions 
Once you have installed codex, you need to install the acp plugin by running
