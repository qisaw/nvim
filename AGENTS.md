...
I use the following frameworks often:
...
You can see the initial setup in ./init.lua and further configurations in the lua/ directory.

I use the "Workman P" keyboard layout, so that is why I have remapped some keys (e.g. hjkl to yneo for navigation).
